...
/**
 * JNI bridge to the Sena Rust host-driven Android API.
 */
public final class NativeSena {
    static {
        System.loadLibrary("sena");
        System.loadLibrary("sena_jni");
    }
    ...
    public static native byte[] frameRgba(long handle);
    public static native int frameWidth(long handle);
    public static native int frameHeight(long handle);
    public static native long frameGeneration(long handle);
