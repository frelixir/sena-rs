...
const uint8_t *sena_ios_frame_rgba(void *handle);
uint32_t sena_ios_frame_width(void *handle);
uint32_t sena_ios_frame_height(void *handle);
uint64_t sena_ios_frame_generation(void *handle);
